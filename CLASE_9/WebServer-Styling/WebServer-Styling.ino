    ...
    while (client.connected())
    {
      if (client.available())
      {
        ...
        if (c == '\n' && currentLineIsBlank)
        {
          ...
          client.println("<html>");
          client.println("<head><link rel=\"stylesheet\" href=\"//maxcdn.bootstrapcdn.com/bootstrap/3.3.5/css/bootstrap.min.css\"></head>");
          client.println("<body>");
          client.println("<h1>Condiciones methorologicas en el aula 6</h1><br>");
          client.print("<table class=\"table\">");
          client.print("<tr><td>Humedad</td><td>Temperatura</td></tr>");
          client.print("<tr><td>");
          client.println(h);
          client.print("</td><td>");
          client.print(t);
          ...
          client.println("<h1>Ventilador</h1>");

          if (!digitalRead(fanPin))
            client.println("<button class=\"btn btn-success\" onClick=\"location.href='/?FAN=ON'\">Encender Ventilador</button><br>");
          else
            client.println("<button class=\"btn btn-warning\" onClick=\"location.href='/?FAN=OFF'\">Apagar Ventilador</button><br>");
