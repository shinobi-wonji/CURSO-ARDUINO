...
void setup() {
  ...
  //analogWrite(pinLeds , brillo); //apago leds que se encienden por default ya que cuando seteo el pinmode por default arduino lo setea en LOW y por la logica negativa se activa.
...
void loop() {
  ...
  distance = (float)deltaTime / 58; //calculo distancia
